<?php
    $cat_obj = get_the_category()[0];
    $category_name = get_the_category()[0]->name;
    $content_type_term = get_the_category()[0]->term;
    $content_type_name = $content_type_term->name;
    if($cat_obj){
    $posts = get_posts([
        'post_type' => 'post',
        'post_status' => 'publish',
    ...
    <div class="appen-wrap" brightfunnel trigger="scroll">
        ...
        <div class="swiper-container js-resourse-slider js-recommended">
            ...
            <div class="recommended__bottom">
                <a href="<?php echo get_term_link( $cat_obj ); ?>" class="btn btn-o"><span><?php _e( 'All', 'appen' ); ?> <?php echo $category_name; ?></span></a>
