<?php
    ...
    if ( !empty( $categories ) ) {
        ...
        $args['tax_query'] = [
            [
                'taxonomy' => 'life_at_appen_category',
                'field' => 'term_id',
                'terms' => $content_type_term->term_id
            ]
        ];
    } else {
        $category_name = 'Life at Appen';
    }
    ...
    <div class="appen-wrap" brightfunnel trigger="scroll">
        ...
        <div class="swiper-container js-resourse-slider js-recommended">
            ...
            <div class="recommended__bottom">
                <a href="<?php echo isset($content_type_term) ? get_term_link( $content_type_term ) : get_post_type_archive_link('life_at_appen'); ?>" class="btn btn-o"><span><?php _e( 'All', 'appen' ); ?> <?php echo $category_name; ?></span></a>
