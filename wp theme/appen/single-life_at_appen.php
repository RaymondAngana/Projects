...
?>
	...
	<main>
		    ...
		    <div class="appen-wrap">
		        <div class="appen-row">
		            ...
		            <div class="appen-col <?php echo $thumbnail ? 'appen-col-6' : ''; ?> blog-hero__col">
		                <?php get_life_at_appen_single_breadcrumbs(); ?>
		...
		<div class="blog-single-social">
		    <div class="appen-wrap">
		        <div class="appen-row appen-row-center">
		            <div class="appen-col hidden-md appen-col-6"><?php echo get_field('socials_text', 'option'); ?></div>
        ...
        <?php get_template_part('template-parts/posts/life/recommended'); ?>
    </main>
