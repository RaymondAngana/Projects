...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__gsap_core_js__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__CSSPlugin_js__ = __webpack_require__(47);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return ScrollTrigger; });
/*!
 * ScrollTrigger 3.8.0
 * https://greensock.com
 *
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__util_Router__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__routes_common__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__routes_singlePost__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__routes_category__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__routes_searchResults__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__routes_singleGhResources__ = __webpack_require__(51);
...
var routes = new __WEBPACK_IMPORTED_MODULE_3__util_Router__["a" /* default */]({
  ...
  singlePost: __WEBPACK_IMPORTED_MODULE_5__routes_singlePost__["a" /* default */],
  category: __WEBPACK_IMPORTED_MODULE_6__routes_category__["a" /* default */],
  searchResults: __WEBPACK_IMPORTED_MODULE_7__routes_searchResults__["a" /* default */],
  singleGhResources: __WEBPACK_IMPORTED_MODULE_8__routes_singleGhResources__["a" /* default */],
});
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_gsap__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_gsap_ScrollTrigger__ = __webpack_require__(18);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  init: function init() {
    ...
    // Init For Bug
    var bug = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].timeline({
      scrollTrigger: {
        trigger: '#bug-trigger',
        start: 'top 5%',
        end: 'center top',
    ...
    $('.slider').on('beforeChange', function(event, slick, currentSlide, nextSlide) {
      if (videoPlaying) {
        stop();
        var video = slick.$slides[currentSlide];
      }
    });
    ...
    var cardArray = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].utils.toArray('.gh-cards');
    ...
    __WEBPACK_IMPORTED_MODULE_1_gsap_ScrollTrigger__["a" /* ScrollTrigger */].saveStyles(".marq-col-content, .column-form, #curve_overlay");
    __WEBPACK_IMPORTED_MODULE_1_gsap_ScrollTrigger__["a" /* ScrollTrigger */].matchMedia({
      // desktop
      "(min-width: 1024px)": function() {
        var anim = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].utils.toArray('.marq-anim')
        if (anim.length > 0){
          var marq = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].timeline({
            scrollTrigger: {
              trigger: '.marq-anim',
              start: 'top center',
            },
    ...
    var featureSplitArray = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].utils.toArray('.feature-split-flushed');
    var fhs_anim = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].utils.toArray('.feature-split-flushed .card-anim');
    if (fhs_anim.length > 0) {
      featureSplitArray.forEach(function (features, i) {
        var tl = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].timeline({
          scrollTrigger: {
            trigger: features,
            start: 'top center',
    ...
    var featureArray = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].utils.toArray('.feature-half');
    var fh_anim = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].utils.toArray('.feature-half .card-anim');
    if (fh_anim.length > 0) {
      featureArray.forEach(function (feature, i) {
        var tl = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].timeline({
          scrollTrigger: {
            trigger: feature,
            start: 'top center',
    ...
    var featureContArray = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].utils.toArray('.feature-contained-half');
    var fch_anim = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].utils.toArray('.feature-contained-half .card-anim');
    if (fch_anim.length > 0) {
      featureContArray.forEach(function (featurec, i) {
        var tl = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].timeline({
          scrollTrigger: {
            trigger: featurec,
            start: 'top center',
    ...
    var featureUniqueArray = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].utils.toArray('.feature-unique-card');
    var fu_anim = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].utils.toArray('.feature-unique-card .card-anim');
    if (fu_anim.length > 0) {
      featureUniqueArray.forEach(function (featurec, i) {
        var tl = __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].timeline({
          scrollTrigger: {
            trigger: featurec,
            start: 'top center',
    ...
    $('.multi-view .button-and-image > span').bind('click keypress', function () {
      ...
      __WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].to($target, {
        opacity: 0,
        x: 1000,
        duration: 1,
      });
    ...
    if (window.matchMedia("(min-width: 1024px)").matches) {
      var cardSets = $('.grid-cards').toArray();
      ...
      var sCardSets = $('.s-grid-cards').toArray();
    ...
    for (p in vars) {
      ...
      if (specialProp) {
        ...
        if (startAt && p in startAt) {
          ...
          Object(__WEBPACK_IMPORTED_MODULE_0__gsap_core_js__["k" /* _isString */])(startValue) && ~startValue.indexOf("random(") && (startValue = Object(__WEBPACK_IMPORTED_MODULE_0__gsap_core_js__["s" /* _replaceRandom */])(startValue));
...
__WEBPACK_IMPORTED_MODULE_0_gsap__["a" /* gsap */].registerPlugin(__WEBPACK_IMPORTED_MODULE_1_gsap_ScrollTrigger__["b" /* default */]);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  init: function init() {
    var negativeDisclaimer = document.getElementById('negative-disclaimer');
    var psCalculate = document.getElementById('pc-calculate'); //button
    var dailyOrders = document.getElementById('daily-orders');
    var averageTicket = document.getElementById('average-ticket');
    var pcRadio = document.getElementsByName('pc-radio');
    var foodCost = document.getElementById('food-cost');
    var laborCost = document.getElementById('labor-cost');
    var additionalOverhead = document.getElementById('add-overhead');
    var moTotal = 0;
    var yrTotal = 0;
    var xOrders = document.getElementsByClassName('x-orders');
    var xFoodCost = document.getElementsByClassName('x-food-cost');
    var xDelFee = document.getElementsByClassName('del-Fee');
    var pcNo = document.getElementById('pc-no');

    window.x_Food_Cost = function() {
      for (var i = 0; i < xFoodCost.length; i++) {
        xFoodCost[i].innerText = "(" + foodCost.value + "% of Average Order)";
      }
    }

    window.x_Orders = function() {
      for (var i = 0; i < xOrders.length; i++) {
        xOrders[i].innerText = "" + dailyOrders.value + "";
      }
    }

    psCalculate.addEventListener("click", function (e) {
      //incremental revenue
      var incMo = parseFloat((dailyOrders.value * averageTicket.value) * 30);
      var incYr = parseFloat((dailyOrders.value * averageTicket.value) * 365);
      ...
      //Marketing fee
      var marMo = parseFloat((dailyOrders.value * averageTicket.value * 0.20) * 30);
      var marYr = parseFloat((dailyOrders.value * averageTicket.value * 0.20) * 365);
      ...
      //Delivery fee
      var delMo = parseFloat((dailyOrders.value * averageTicket.value * 0.10) * 30);
      var delYr = parseFloat((dailyOrders.value * averageTicket.value * 0.10) * 365);

      if(pcNo.checked){
       delMo = parseFloat(0); 
       delYr = parseFloat(0); 
       for (var i = 0; i < xDelFee.length; i++) {
    ...
    document.getElementById('pc-del-fee-yr').innerText = "-$" + delYr.toLocaleString(
      ...
      //Processing fee
      var proMo = parseFloat((dailyOrders.value * averageTicket.value * 0.0305 + (dailyOrders.value * 0.30)) * 30);
      var proYr = parseFloat((dailyOrders.value * averageTicket.value * 0.0305 + (dailyOrders.value * 0.30)) * 365);
      ...
      //Food cost
      var foodMo = parseFloat((dailyOrders.value * averageTicket.value * (foodCost.value / 100) * 30));
      var foodYr = parseFloat((dailyOrders.value * averageTicket.value * (foodCost.value / 100) * 365));
      ...
      //additional staff
      var laborMo = parseFloat(laborCost.value * 30) || 0;
      var laborYr = parseFloat(laborCost.value * 365) || 0;
      ...
      //additional overhead
      var overMo = parseFloat(additionalOverhead.value * 30) || 0;
      var overYr = parseFloat(additionalOverhead.value * 365) || 0;
      ...
      //Totals
      var moTotal = parseFloat(incMo - marMo - delMo - proMo - foodMo - laborMo - overMo).toLocaleString(
        undefined, {
          minimumFractionDigits: 2,
        }
        );

      var yrTotal = parseFloat(incYr - marYr - delYr - proYr - foodYr - laborYr - overYr).toLocaleString(
        undefined, {
          minimumFractionDigits: 2,
        }
        );

      var moItems = document.getElementsByClassName('pc-mo');
      var yrItems = document.getElementsByClassName('pc-yr');

      for (var i$1 = 0; i$1 < moItems.length; i$1++) {
        moItems[i$1].innerText = "$" + moTotal;
      }

      for (var i$2 = 0; i$2 < yrItems.length; i$2++) {
        yrItems[i$2].innerText = "$" + yrTotal;
      }
