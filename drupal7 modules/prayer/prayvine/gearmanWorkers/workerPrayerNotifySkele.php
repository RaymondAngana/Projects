...
define('DRUPAL_ROOT', '/var/www/sites/prayvine.prometdev.com/www');
...
$_SERVER['HTTP_HOST'] = 'prayvine.prometdev.com'; // optional but required for multi site configs
...
$timer = time();
$worker->addServer();
$worker->addFunction("prayer_notify_skele", "prayvine_prayer_notify");
