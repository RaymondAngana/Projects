...
(function($) {
   Drupal.behaviors.prayvine_tutorial_ordinary = {
    attach: function(context) {
      ...
      var state_tutorial = Drupal.settings.prayvine_tutorial_ordinary_state.json_url;
      ...
      $.get(state_tutorial,function(data){
        ...
        for (i=0;i<7;i++) {
          ...
          if (steps[i] == 0) {//find first that is no processed and live loop
            if (i==0) {
              if ($('#prayvine-tutorial-ordinary-1-form').length == 0) {
                $('#prayvine-tutorial-ordinary-link-1').trigger('click');
            ...
            if (i==1) {
              ...
              if ($('#prayvine-tutorial-ordinary-2-form').length == 0) {
                $('#prayvine-tutorial-ordinary-link-2').trigger('click');

              }
            }
            if (i==2) {

              if ($('#prayvine-tutorial-ordinary-3-form').length == 0) {
                $('#prayvine-tutorial-ordinary-link-3').trigger('click');

              }

            }
            if (i==3) {
              if ($('#prayvine-tutorial-ordinary-4-form').length == 0) {
                $('#prayvine-tutorial-ordinary-link-4').trigger('click');
            ...
            if (i==4) {
              if ($('#prayvine-tutorial-ordinary-5-form').length == 0) {
                $('#prayvine-tutorial-ordinary-link-5').trigger('click');

              }

            }
            if (i==5) {
              if ($('#prayvine-tutorial-ordinary-6-form').length == 0) {
                $('#prayvine-tutorial-ordinary-link-6').trigger('click');

              }

            }
            if (i==6) {
              if ($('#prayvine-tutorial-ordinary-7-form').length == 0) {
                $('#prayvine-tutorial-ordinary-link-7').trigger('click');
      ...
      var tutrial_form_4 = $('#prayvine-tutorial-ordinary-4-form');
      if (tutrial_form_4.length > 0) {
        var facebook = document.getElementById('facebook-jssdk');
        if (facebook !== null){
          $.getScript( "/sites/all/modules/custom/prayvine_tutorial_ordinary/facebook_login.js", function( data, textStatus, jqxhr ) {
      ...
      if ($('#canvas').length > 0 ) {
        ...
        function saveImage() {
          ...
          var set_url = Drupal.settings.base_url.url+'/prayvine_tutorial_ordinary/save_image';
          $.ajax({
            url: set_url,
            data: post_data,
            type: 'POST',
      ...
      if ($('#fb-picture').length > 0) {
        ...
        $('#prayvine-tutorial-ordinary-5-form h2').after(load_text);



      }

      var tutrial_form_5 = $('#prayvine-tutorial-ordinary-5-form');
      if (tutrial_form_5.length > 0) {
        ...
        function replace() {
          var uploaded_file = $('#prayvine-tutorial-ordinary-5-form').find('a');
      ...
      var tutorial_form_7 = $('#prayvine-tutorial-ordinary-7-form');
